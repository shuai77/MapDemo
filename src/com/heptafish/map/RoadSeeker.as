...
package com.heptafish.map
{
	...
	public class RoadSeeker
	{
		...
		private var _pMap:Array;//传入的参数数组
...
//			_directRow = _map[0].length;
//			_directEndPoint = HeptaFishPointExchange.countRightAngle(end.x,end.y,_directRow);
...
//			var __nodePoint:Point = HeptaFishPointExchange.countRightAngle(node.x,node.y,_directRow);
//			var __dx:Number = Math.abs(__nodePoint.x-_directEndPoint.x);
//			var __dy:Number = Math.abs(__nodePoint.y-_directEndPoint.y);
